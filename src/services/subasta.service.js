  ...
  let subastaArray = [
    {
      ...
      nombre: "Agente",
      codigo: "101", 
      imagen :"https://3.bp.blogspot.com/-OXd22pi2f5k/VEXi5TWJ0fI/AAAAAAAAAkU/KrnR_tv4ZLk/s1600/coronelgivens11.jpg", 
      precio:700.00
    },
...
function obtenerDetalleGallo(codigo) {
  let subastaArray = [
    {
      id:1, 
      nombre: "Agente",
    ...
    },
    {
        ...
        info:"Padre 02",  
        codigo: "102", 
        imagen :"https://2.bp.blogspot.com/-JYhXdDR7lv4/VEXi6ewQtBI/AAAAAAAAAkg/JQNgZAEyd8s/s1600/coronelgivens15.jpg", 
        precio:450.00
    },
  ]

  let gallo = subastaArray.find((i) => i.codigo == codigo)
  const subasta = Promise.resolve(gallo);
  return subasta;
}
