...
const EditaEvento = (props) => {
    ...
    const editarEvento = async (e) => {
        try {
            let _body = { Accion: "EDITAR", Emp_cCodigo: Emp_cCodigo, Pan_cAnio:Pan_cAnio,Per_cPeriodo:Per_cPeriodo,Dvm_cNummov:Dvm_cNummov,Vtt_cTipoEvento:Vtt_cTipoEvento,Dvm_cDescripcion:Dvm_cDescripcion,Dvm_dInicio:Dvm_dInicio,Dvm_dFin:Dvm_dFin,Dvm_cEstado:Dvm_cEstado}
            await eventoService.obtenerEventosCabAuth(_body).then(
                (res) => {
                    setData(res[0]);
                },
